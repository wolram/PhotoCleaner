...
struct SieveSelectionView: View {
    ...
    @State private var showingSieve = false
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingSieve) {
    ...
    private var emptyState: some View {
        VStack(spacing: 20) {
            ...
            Text("Run a scan first to find duplicate or similar photo groups to sieve!")
                .font(.body)
